...
export class AuthService {
  ...
  getToken() {
    ...
    getappointment() {
        ...
        return this.http.get(this.env.API_URL + 'api/getappointment', { headers: headers })
            .pipe(
                tap(item => {
                    return item;
                })
    ...
    book(date, time, service) {
        ...
        return this.http.post(this.env.API_URL + 'api/book', {date:date, time:time, service:service},{ headers: headers })
            .pipe(
                tap(user => {
                    return user;
                })
